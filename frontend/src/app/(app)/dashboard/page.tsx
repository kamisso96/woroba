        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle
                className={`text-2xl ${alerts > 0 ? 'text-amber-600' : ''}`}
              >
                {alerts}
              </CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-2xl">{formatPrice(todayRevenue)}</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <ul className="divide-y">
                  {sales.slice(0, 5).map((s) => (
                    ...
                    >
                      ...
                      <span className="font-medium">{formatPrice(s.totalAmount)}</span>
                    </li>
                  ))}
                </ul>
              ) : (
