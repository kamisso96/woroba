...
// Photo : boutique / epicerie de quartier (adaptee a la gestion de stock)
const BACKGROUND_URL =
  'https://images.unsplash.com/photo-1692689383138-c2df3476072c?q=80&w=1170&auto=format&fit=crop';
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-emerald-950">
      ...
      <div className="relative flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-10">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_90px_-20px_rgba(0,0,0,0.6)] md:h-[70vh] md:min-h-[560px] md:grid-cols-2">
          ...
          <div className="relative hidden overflow-hidden md:block">
            ...
            {/* Vague blanche verticale (S asymetrique) */}
            <svg
            ...
            <div className="absolute bottom-8 left-8 right-8 z-10">
              ...
              <p className="mt-1 text-xs text-white/70">
                Produits · Ventes · Mouvements · Rapports
              </p>
            </div>
          </div>
